...
export interface PlanRisk {
  riskCode:
    ...
    | "unresolved_occupation"
    | "unresolved_skill"
    | "qualification_dependency"
    | "experience_dependency"
    | "taxonomy_data_unavailable"
...
export interface PlanningInput {
  ...
  goal: CareerGoal;
  skillLevels?: Array<{ skillCode: string; level?: number }>;
