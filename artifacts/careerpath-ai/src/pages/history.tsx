      ...
      <div className="p-8 max-w-4xl mx-auto space-y-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">See readiness changes over time.</p>
          </div>
        </div>
        ...
        {noHistory && (
          <ProductEmptyState
            ...
            description="Run analysis now, then compare future readiness scores as your profile improves."
        ...
        {history && history.length > 0 && (
          <div className="space-y-4">
            {history.map((item, idx) => (
              <Card key={item.id} className={idx === 0 ? "blue-card-strong" : "blue-card"}>
